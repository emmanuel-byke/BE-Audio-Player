...
class AnimatedToggle(QCheckBox):
    ...
    def __init__(self,
        parent=None, bar_color=Qt.GlobalColor.gray, checked_color="#00B0FF", handle_color=Qt.GlobalColor.white, 
        pulse_unchecked_color="#44999999", pulse_checked_color="#4400B0EE", x=0, y=0, name='', save_name='', save_value=''):
        ...
        self.label.setGeometry(x, y, 100, 45)
        self.label.show()
        self.move(x+100, y)
